package com.org.shoppingcart.core.doc;
...
public class SwaggerConfig {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Dimuthu", "http://inovaitsys.com",
			"dnwnalaka@gmail.com");
	public static final ApiInfo DEFAULT = new ApiInfo("Api Documentation of Shopping Cart Core Service",
			"Api Documentation of Shopping Cart Core Service", "1.0.0", "urn:tos", DEFAULT_CONTACT, "Apache 2.0",
