...
public class RabbitMQConfig {
	...
	@Bean
	public SimpleMessageListenerContainer listenerContainer(ShoppingCartMessageListener shoppingCartMessageListener) {
		SimpleMessageListenerContainer listenerContainer = new SimpleMessageListenerContainer();
		listenerContainer.setConnectionFactory(connectionFactory());
		listenerContainer.setQueueNames(congifDetails.getQueue());
		listenerContainer.setMessageListener(shoppingCartMessageListener);
